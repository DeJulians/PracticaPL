...
public class gramaticaParser extends Parser {
	...
	public String funciones = "<H2>Funciones:</H2>\n" + "<UL>\n" + "<LI><A HREF=\"#principal\">Programa principal</A></LI></UL>";
	...
	public final SentlistContext sentlist() throws RecognitionException {
		...
		try {
			...
			setState(144);
			match(T__1);
			((SentlistContext)_localctx).t =  ((SentlistContext)_localctx).mainhead.t + " {" + ((SentlistContext)_localctx).code.t + "}<br>" + "<A HREF=\"#principal\">Inicio del Programa Principal</A><a>  </a><A HREF=\"#programa\">Inicio del Programa</A>";
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final CtedefContext ctedef() throws RecognitionException {
		...
		try {
			...
			((CtedefContext)_localctx).t =  "<SPAN CLASS=\"palres\">#define</SPAN> " + "<SPAN CLASS=\"cte\">" + (((CtedefContext)_localctx).CONST_DEF_IDENTIFIER!=null?((CtedefContext)_localctx).CONST_DEF_IDENTIFIER.getText():null) + "</SPAN> " + ((CtedefContext)_localctx).simpvalue.t + "<br>" + ((CtedefContext)_localctx).ctelist1.t + "";
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Ctelist1Context ctelist1() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				((Ctelist1Context)_localctx).t =  "<SPAN CLASS=\"palres\">#define</SPAN> " + "<SPAN CLASS=\"cte\">" + (((Ctelist1Context)_localctx).CONST_DEF_IDENTIFIER!=null?((Ctelist1Context)_localctx).CONST_DEF_IDENTIFIER.getText():null) + "</SPAN> " + ((Ctelist1Context)_localctx).simpvalue.t + "<br>" + ((Ctelist1Context)_localctx).ctelist1.t;
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	public final VarlistContext varlist() throws RecognitionException {
		...
		try {
			...
			((VarlistContext)_localctx).t =  ((VarlistContext)_localctx).vardef.t + ";<br>" + ((VarlistContext)_localctx).varlist1.t;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Varlist1Context varlist1() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				((Varlist1Context)_localctx).t =  ((Varlist1Context)_localctx).vardef.t + ";<br>" + ((Varlist1Context)_localctx).varlist1.t;
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	public final FuncdefContext funcdef() throws RecognitionException {
		...
		try {
			...
			funciones += "<UL><A HREF=\"#FUNCIONES:funcion" + contador + "\">" + "<LI>" + ((FuncdefContext)_localctx).funchead.t + "</LI></A></UL>";
			setState(224);
			match(T__0);
			setState(225);
			...
			setState(226);
			match(T__1);
			((FuncdefContext)_localctx).t =  "<DIV><A name=\"FUNCIONES:funcion" + contador + "\">" + ((FuncdefContext)_localctx).funchead.t + "</A>{<br>" + ((FuncdefContext)_localctx).code.t + "<br>}<br></DIV><A HREF=\"#FUNCIONES:funcion" + contador + "\">Iicio de la funcion</A><a>  </a><A HREF=\"#principal\">Programa Principal</A><HR>"; contador++;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final IfaContext ifa() throws RecognitionException {
		...
		try {
			...
			((IfaContext)_localctx).t =  "<SPAN CLASS=\"palres\">if</SPAN> " + ((IfaContext)_localctx).expcond.t + "{<br>" + ((IfaContext)_localctx).code.t + "<br>}<br>" + ((IfaContext)_localctx).elsea.t;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ForaContext fora() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(356);
				match(T__1);
				((ForaContext)_localctx).t =  "<SPAN CLASS=\"palres\">for</SPAN>(" + ((ForaContext)_localctx).vardef.t + "; " + ((ForaContext)_localctx).expcond.t + "; " + ((ForaContext)_localctx).asig.t + "){<br>" + ((ForaContext)_localctx).code.t +"<br>}<br>";
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
